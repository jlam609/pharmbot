  ...
  return (
    <div>
      ...
      >
        ...
        <p>
          {`Constipation remedies include a wide selection of products. \n For best results a combination of a stool softener and stimulant laxative is best.\n For emergencies enemas are most effective.`}{" "}
        </p>
        <p> Here is our recommendation! </p>
        <br />
